...
leer_ticket <- function(x) {
  ...
  fecha_hora_op <- strsplit(trimws(linea_fecha_hora_op), "\\s+")[[1]]  #Usamos strsplit para dividir esa línea por espacios y extraer los elementos en posiciones fijas
  ...
  factura_simplificada <- trimws(sub(".*FACTURA SIMPLIFICADA:", "", linea_factura)) 
