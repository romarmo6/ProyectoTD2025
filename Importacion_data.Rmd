...
leer_ticket <- function(x) {
  ...
  #"\\s+" divide la cadena de texto cuando se encuentra varios espacios en blanco 
  ...
  if (nrow(productos_unitarios) > 0) {
    ...
    productos_unitarios$total_compra <- total_compra
  }
...
#Como es normal, la localidad con más ingresos es Valencia, con más de 90000 € ingresados.
#A esta le sigue Alcoy con unos 70000€ y Muro de Alcoyque baja a unos 30000€
```
