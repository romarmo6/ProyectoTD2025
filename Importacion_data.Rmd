...
dplyr, stringr para la manipulación de datos
...
knitr::kable(head(df_tickets[,1:9], 15), caption = "**TABLA 1. Datos importados. 1ª parte**")
knitr::kable(head(df_tickets[,9:18], 15), caption = "**TABLA 2. Datos importados. 2ª parte**")
```
...
Cantidad: número de unidades que se compran de cada producto si son unitarios
```{r}
